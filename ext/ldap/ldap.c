...
/* $Id: ldap.c,v 1.161.2.3.2.11.2.19 2008/10/24 14:35:35 felipe Exp $ */
...
PHP_MINFO_FUNCTION(ldap)
{
	...
	php_info_print_table_row(2, "RCS Version", "$Id: ldap.c,v 1.161.2.3.2.11.2.19 2008/10/24 14:35:35 felipe Exp $");
