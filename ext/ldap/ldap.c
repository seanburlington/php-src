...
/* $Id: ldap.c,v 1.161.2.3.2.11.2.20 2008/11/02 21:19:34 felipe Exp $ */
...
PHP_MINFO_FUNCTION(ldap)
{
	...
	php_info_print_table_row(2, "RCS Version", "$Id: ldap.c,v 1.161.2.3.2.11.2.20 2008/11/02 21:19:34 felipe Exp $");
