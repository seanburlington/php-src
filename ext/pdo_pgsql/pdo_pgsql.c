...
/* $Id: pdo_pgsql.c,v 1.7.2.11.2.1.2.2 2007/12/31 07:17:12 sebastian Exp $ */
...
PHP_MINFO_FUNCTION(pdo_pgsql)
{
	...
	php_info_print_table_row(2, "Revision", " $Id: pdo_pgsql.c,v 1.7.2.11.2.1.2.2 2007/12/31 07:17:12 sebastian Exp $ ");
