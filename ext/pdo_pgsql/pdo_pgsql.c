...
/* $Id: pdo_pgsql.c,v 1.7.2.12 2007/01/01 09:40:27 sebastian Exp $ */
...
PHP_MINFO_FUNCTION(pdo_pgsql)
{
	...
	php_info_print_table_row(2, "Revision", " $Id: pdo_pgsql.c,v 1.7.2.12 2007/01/01 09:40:27 sebastian Exp $ ");
