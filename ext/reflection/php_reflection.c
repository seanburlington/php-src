...
/* $Id: php_reflection.c,v 1.164.2.33.2.45.2.38 2008/11/02 21:19:35 felipe Exp $ */
...
PHP_MINFO_FUNCTION(reflection) /* {{{ */
{
	...
	php_info_print_table_row(2, "Version", "$Id: php_reflection.c,v 1.164.2.33.2.45.2.38 2008/11/02 21:19:35 felipe Exp $");
