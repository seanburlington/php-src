/*
   ...
   $Id: sqlite.c,v 1.166.2.14 2007/01/01 09:40:28 sebastian Exp $
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.166.2.14 2007/01/01 09:40:28 sebastian Exp $");
