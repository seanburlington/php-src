/*
   ...
   $Id: sqlite.c,v 1.209 2008/07/01 18:30:20 felipe Exp $
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.209 2008/07/01 18:30:20 felipe Exp $");
