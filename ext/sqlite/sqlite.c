/*
   ...
   $Id: sqlite.c,v 1.114 2004/01/15 21:30:31 helly Exp $ 
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.114 2004/01/15 21:30:31 helly Exp $");
