/*
  ...
  $Id: sqlite.c,v 1.42 2003/05/14 13:05:22 wez Exp $ 
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.42 2003/05/14 13:05:22 wez Exp $");
