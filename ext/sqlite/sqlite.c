/*
  ...
  $Id: sqlite.c,v 1.39 2003/05/02 22:22:16 helly Exp $ 
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.39 2003/05/02 22:22:16 helly Exp $");
