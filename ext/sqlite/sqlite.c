/*
   ...
   $Id: sqlite.c,v 1.184 2006/02/13 10:23:58 dmitry Exp $
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.184 2006/02/13 10:23:58 dmitry Exp $");
