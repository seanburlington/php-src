/*
   ...
   $Id: sqlite.c,v 1.66 2003/06/27 14:30:26 edink Exp $ 
*/
...
PHP_MINFO_FUNCTION(sqlite)
{
	...
	php_info_print_table_row(2, "PECL Module version", PHP_SQLITE_MODULE_VERSION " $Id: sqlite.c,v 1.66 2003/06/27 14:30:26 edink Exp $");
