...
/* $Id: tidy.c,v 1.66.2.4 2005/12/06 02:25:34 sniper Exp $ */
...
PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.66.2.4 2005/12/06 02:25:34 sniper Exp $)");
