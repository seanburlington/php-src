...
/* $Id: tidy.c,v 1.66.2.8.2.9 2006/08/31 13:58:31 tony2001 Exp $ */
...
static PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.66.2.8.2.9 2006/08/31 13:58:31 tony2001 Exp $)");
