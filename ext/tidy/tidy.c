...
/* $Id: tidy.c,v 1.30 2004/01/08 00:03:54 fmk Exp $ */
...
PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.30 2004/01/08 00:03:54 fmk Exp $)");
