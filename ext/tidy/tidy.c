...
/* $Id: tidy.c,v 1.66.2.1 2005/10/12 14:29:26 tony2001 Exp $ */
...
PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.66.2.1 2005/10/12 14:29:26 tony2001 Exp $)");
