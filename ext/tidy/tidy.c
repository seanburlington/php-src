...
/* $Id: tidy.c,v 1.38 2004/02/12 10:43:26 zeev Exp $ */
...
PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.38 2004/02/12 10:43:26 zeev Exp $)");
