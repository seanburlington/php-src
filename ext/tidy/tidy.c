...
/* $Id: tidy.c,v 1.124 2008/10/24 14:34:16 felipe Exp $ */
...
static PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.124 2008/10/24 14:34:16 felipe Exp $)");
