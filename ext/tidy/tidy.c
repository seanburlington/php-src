...
/* $Id: tidy.c,v 1.21 2003/12/15 01:43:45 john Exp $ */
...
PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c,v 1.21 2003/12/15 01:43:45 john Exp $)");
