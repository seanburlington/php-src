...
/* $Id: php_zip.c,v 1.1.2.38.2.3 2007/12/15 12:52:55 bjori Exp $ */
...
static PHP_MINFO_FUNCTION(zip)
{
	...
	php_info_print_table_row(2, "Extension Version","$Id: php_zip.c,v 1.1.2.38.2.3 2007/12/15 12:52:55 bjori Exp $");
