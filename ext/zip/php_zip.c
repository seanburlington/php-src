...
/* $Id: php_zip.c,v 1.1.2.38.2.25 2008/11/17 11:28:01 felipe Exp $ */
...
static PHP_MINFO_FUNCTION(zip)
{
	...
	php_info_print_table_row(2, "Extension Version","$Id: php_zip.c,v 1.1.2.38.2.25 2008/11/17 11:28:01 felipe Exp $");
