...
/* $Id: php_zip.c,v 1.1.2.38.2.2 2007/10/07 05:22:07 davidw Exp $ */
...
static PHP_MINFO_FUNCTION(zip)
{
	...
	php_info_print_table_row(2, "Extension Version","$Id: php_zip.c,v 1.1.2.38.2.2 2007/10/07 05:22:07 davidw Exp $");
