...
/* $Id: php_zip.c,v 1.1.2.38.2.22 2008/11/02 21:19:38 felipe Exp $ */
...
static PHP_MINFO_FUNCTION(zip)
{
	...
	php_info_print_table_row(2, "Extension Version","$Id: php_zip.c,v 1.1.2.38.2.22 2008/11/02 21:19:38 felipe Exp $");
