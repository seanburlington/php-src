...
/* $Id: php_zip.c,v 1.1.2.38.2.1 2007/09/27 18:00:46 dmitry Exp $ */
...
static PHP_MINFO_FUNCTION(zip)
{
	...
	php_info_print_table_row(2, "Extension Version","$Id: php_zip.c,v 1.1.2.38.2.1 2007/09/27 18:00:46 dmitry Exp $");
