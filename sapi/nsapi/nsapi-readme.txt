...
<path-to-server>/https-servername/config/magnus.conf file:
    ...
    Init fn="load-modules" funcs="php6_init,php6_execute,php6_auth_trans" shlib="/path/to/phplibrary"
    Init fn=php6_init errorString="Failed to initialize PHP!" [php_ini="/path/to/php.ini"]
...
every error page you want to overwrite:
    ...
    Error fn="php6_execute" code=XXX script="/path/to/script.php" [inikey=value inikey=value...]
...
type="magnus-internal/directory" in obj.conf with the following:
    ...
    Service fn="php6_execute" type="magnus-internal/directory" script="/path/to/script.php" [inikey=value inikey=value...]
