...
/* $Id: pi3web_sapi.c,v 1.60.2.1.2.1.2.1 2007/12/31 07:17:18 sebastian Exp $ */
...
static void php_info_pi3web(ZEND_MODULE_INFO_FUNC_ARGS)
{
	...
	php_info_print_table_row(2, "Pi3Web SAPI module version", "$Id: pi3web_sapi.c,v 1.60.2.1.2.1.2.1 2007/12/31 07:17:18 sebastian Exp $");
