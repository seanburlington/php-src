...
/* $Id: roxen.c,v 1.47.2.2 2002/02/03 00:38:00 yohgaki Exp $ */
...
static void php_info_roxen(ZEND_MODULE_INFO_FUNC_ARGS)
{
  ...
  php_info_print_table_row(2, "SAPI module version", "$Id: roxen.c,v 1.47.2.2 2002/02/03 00:38:00 yohgaki Exp $");
