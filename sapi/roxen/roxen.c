...
/* $Id: roxen.c,v 1.61.2.3 2007/01/01 09:40:33 sebastian Exp $ */
...
static void php_info_roxen(ZEND_MODULE_INFO_FUNC_ARGS)
{
  ...
  php_info_print_table_row(2, "SAPI module version", "$Id: roxen.c,v 1.61.2.3 2007/01/01 09:40:33 sebastian Exp $");
