...
/* $Id: roxen.c,v 1.61.2.1 2005/12/06 01:14:02 sniper Exp $ */
...
static void php_info_roxen(ZEND_MODULE_INFO_FUNC_ARGS)
{
  ...
  php_info_print_table_row(2, "SAPI module version", "$Id: roxen.c,v 1.61.2.1 2005/12/06 01:14:02 sniper Exp $");
